...
def middle_way(a, b):
    return [a[int(len(a)/2)], b[len(b)//2]]
...
def squirrel_play(temp, is_summer):
    if temp in range(60, 91) and not is_summer:
        return True
    elif temp in range(60, 101) and is_summer:
        return True
    else:
        return False
...
def pego_correndo(speed, is_birthday):
  if speed in range (61,81) and not is_birthday or speed in range (66,86) and is_birthday:
    return 1
...
def alarm_clock(day, vacation):
    clock_dia_semana = '7:00'
    clock_final_semana = '10:00'
    if vacation:
        clock_dia_semana = '10:00'
        clock_final_semana = 'off'
    return clock_dia_semana if day in range(1, 6) else clock_final_semana
